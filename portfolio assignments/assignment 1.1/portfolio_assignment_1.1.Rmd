...
``` {r opdracht1.1}
dataset_Elegans <- read_excel("~/School/Jaar 4/Workflows/Portfolio/portfolio assignments/assignment 1.1/CE.LIQ.FLOW.062_Tidydata.xlsx")
...
To learn whether there is indeed an effect of different concentrations on offspring count and whether the different compounds have a different curve (IC50). Write down you analysis as a step-wise plan.
